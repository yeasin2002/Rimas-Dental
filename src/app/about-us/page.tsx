						...
						<div className="flex flex-col items-center justify-center space-y-4 text-center">
							<div className="space-y-2">
								...
								<p className="max-w-[900px] text-gray-500 dark:text-gray-400 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
									...
									patients receive the most efficient and comfortable treatment.
								</p>
							</div>
							<div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3 lg:gap-12">
								<div className="grid gap-1">
									...
									<p className="text-sm text-gray-500 dark:text-gray-400">
										Our digital x-ray technology provides clear, detailed images
								...
								<div className="grid gap-1">
									...
									<p className="text-sm text-gray-500 dark:text-gray-400">
										...
										images of your teeth, making it easier to diagnose and treat
										any issues.
									</p>
								</div>
								<div className="grid gap-1">
									...
									<p className="text-sm text-gray-500 dark:text-gray-400">
										...
										comfort, ensuring a pleasant experience during your visits.
									</p>
								</div>
							</div>
						</div>
					...
					<div className="container px-4 md:px-6">
						<div className="flex flex-col items-center justify-center space-y-4 text-center">
							<div className="space-y-2">
								...
								<p className="max-w-[900px] text-gray-500 dark:text-gray-400 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
									At {`Rima's`} Dental, we understand that visiting the dentist
									can be a source of anxiety for some people. {`That's`} why
									{`we've`} made it our mission to create a warm, welcoming, and
									comfortable environment for all our patients.
								</p>
							</div>
							<div className="flex flex-col gap-2 min-[400px]:flex-row">
								<a

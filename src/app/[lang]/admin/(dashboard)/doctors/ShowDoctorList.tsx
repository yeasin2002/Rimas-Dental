...
export const ShowDoctorList = ({ doctors, ...props }: Props) => {
	return (
		<section className="p-4" {...props}>
			<div className="mt-2">
				<div>
					<h1 className="font-grotesk text-4xl font-bold text-main-400 sm:text-5xl md:text-6xl lg:text-7xl">Doctors</h1>
			...
			<div>
				{doctors.length === 0 ? (
					<div className="flex flex-col items-center justify-center">
						<Image src={virusDisinfection} alt="No Doctor" className="size-72" />

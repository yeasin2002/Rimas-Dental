...
export const OurTeam = async ({ dictionary, ...props }: Props) => {
	...
	return (
		<section {...props} className="home_sections-container mt-10 md:container md:py-6 2xl:pt-16">
			<div className="space-y-2 *:text-center">
				<p className="font-semibold text-yellowOrange-100 2xl:text-3xl">{dictionary.subHeading}</p>
				<h2 className={`font-grotesk text-2xl font-bold text-deepBlue-100 mini:text-3xl 2xl:text-5xl`}>
					{dictionary.heading}
				</h2>
